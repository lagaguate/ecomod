loadfunctions("utility", functionname="na.zero.r")
  library(RODBC)
  ...
  nulls_query="SELECT GROUNDFISH.GSINF.MISSION,
  GROUNDFISH.GSINF.SETNO,
  to_char(GROUNDFISH.GSINF.SDATE,'YYYY') YEAR,
  GROUNDFISH.GSINF.SDATE,
  (SUBSTR(GROUNDFISH.GSINF.SLONG,1,2)+ROUND(((GROUNDFISH.GSINF.SLONG-(SUBSTR(GROUNDFISH.GSINF.SLONG,1,2)*100))/60),2))*-1 SLONG,
...
colnames(all.recs)[colnames(all.recs) == 'TOTNO.y'] = "TOTNO"
colnames(all.recs[colnames(all.recs) == 'TOTWGT.y'] = "TOTWGT"
