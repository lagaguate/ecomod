...
p$init.files = loadfunctions( c(
  ...
  "condition", "speciesarea", "speciescomposition", "metabolism", "sizespectrum", "mpa" ))
...
p$map.depthcontours = c(0, 100, 200, 300, 400, 500, 600 ) # to plot on maps
p$map.depthcontours.colours = c( "steelblue2", "gray90", "gray85", "gray80", "gray74", "gray72", "gray70" ) 


# obtain polygons of the mpa/aoi
p = mpa.db( p=p, DS="polygons" )
