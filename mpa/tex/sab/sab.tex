...
\begin{figure}[h]
	\label{fig:Scallop}
	\centering
	\includegraphics[width=1.0\textwidth]{\sab Rplot.png}
...
\begin{figure}[h]
	\label{fig:halibut}
	\centering
	\includegraphics[width=1.0\textwidth]{\sab Rplot01.png}
...
Again, this also has a simple and obvious implication in terms of monitoring and assessment. If the goal is to resolve short-term processes then sampling must also, of necessity be more frequent. 
