...
\newcommand{\analysis}{\string~/ecomod_data/mpa/analysis/}   %  \string~ is a representation of the 
...
Thus, to reiterate, the focal ecosystem components of the Ocean's Act MPA's, include:
...
\begin{itemize}
	\item large ecosystem and as such complex, operating at various space, time and organisational scales
...
\subsection{Ecosystem data description}
\subsubsection{Discrete Bottle Data: Chlorophyll-a and Nutrients}
...
\begin{figure}[h]
  ...
  \end{tabular}
  \caption{Monthly averages of all data from 1999 to 2014: total abundance (top left), total biomass computed from wet weight (top right), ratio of total biomass computed from wet weight  to total abundance (bottom center) as a potential measure of the average weight of the individual organism, Calanus finmarchicus, Calanus hyperboreus, and Calanus glacialis }
  \label{fig2.3.2-3}
  % Figure 2.3.2-3: 
\end{figure}
...
\begin{figure}[h]
  \centering
  \begin{tabular}{cc}
    \includegraphics[width=0.5\textwidth]{\sab 12.jpg}
    \includegraphics[width=0.5\textwidth]{\sab 13.jpg}
  \end{tabular}
  \begin{tabular}{cc}
    \includegraphics[width=0.5\textwidth]{\sab 14.jpg}
    \includegraphics[width=0.5\textwidth]{\sab 15.jpg}
  \end{tabular}
...
\subsubsection{Bottom temperatures}
...
\subsubsection{Demersal fish (and macro-invertebrates)}
\begin{itemize}
  \item Relevance:  productivity, habitat, biodiversity and species of interest
...
\subsubsection{Benthic macroinvertebrates (and demersal fish)}
\begin{itemize}
  \item Relevance:  productivity, habitat, biodiversity and species of interest
...
\subsubsection{Other ecosystem data not being considered}
\begin{itemize}
...
\subsection{Human usage of the ocean}
\subsubsection{Fishery activity}
...
\subsubsection{Other data not being considered}
\begin{itemize}
...
\subsection{AZMP}
\subsubsection{Discrete bottle data}
...
\begin{itemize}
  ...
  \item Phosphate: 0-4.5 mmol/
  
  Any values outside of expected range were removed for open ocean data only.m\textsuperscript{3}
...
\hline
{{\large \textsf{Parameter}}}&
{{\large \textsf{Depth interval}}}&
{{\large \textsf{Expected Range}}}\\
\hline
{{\large \textsf{Chlorophyll-a}}}&
{{\large \textsf{0-1500 m}}}&
{{\large \textsf{0-50 mg/m}}}\textsuperscript{{{\scriptsize \textsf{3}}}}\\
\hline
{{\large \textsf{Silicate}}}&
{{\large \textsf{0-150 m}}}&
{{\large \textsf{0-250 mmol/m}}}\textsuperscript{{{\scriptsize \textsf{3}}}}\\
\hline
{{\large \textsf{Silicate}}}&
{{\large \textsf{150-900 m}}}&
{{\large \textsf{0.01-250 mmol/m}}}\textsuperscript{{{\scriptsize \textsf{3}}}}\\
\hline
{{\large \textsf{Phosphate}}}&
{{\large \textsf{0-500 m}}}&
{{\large \textsf{0-4.5 mmol/m3}}}\\
\hline
{{\large \textsf{Phosphate}}}&
{{\large \textsf{150-1500 m}}}&
{{\large \textsf{0.01-4.5 mmol/m}}}\textsuperscript{{{\scriptsize \textsf{3}}}}\\
\hline
{{\large \textsf{Nitrate}}}&
{{\large \textsf{0-1500 m}}}&
{{\large \textsf{0-515 mmol/m}}}\textsuperscript{{{\scriptsize \textsf{3}}}}\\
\hline
\end{tabular}
\end{table}
...
\subsubsection{Chlorophyll-a methods}
...
\hline
{{\large \textsf{Method}}}&
{{\large \textsf{Description}}}\\
\hline
{{\large \textsf{Chl\_a}}}&
{{\large \textsf{Unknown method}}}\\
\hline
{{\large \textsf{Chl\_a\_Holm-Hansen\_F}}}&
{{\large \textsf{Holm-Hansen method; Prefiltered; Frozen before analysis (-20°C)}}}\\
\hline
{{\large \textsf{Chl\_a\_Holm-Hansen\_sF}}}&
{{\large \textsf{Holm-Hansen method ; Super Frozen before analysis (-196°C)}}}\\
\hline
{{\large \textsf{Chl\_a\_Welschmeyer\_sF}}}&
{{\large \textsf{Welschmeyer method; Super Frozen before analysis  (-196°C)}}}\\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[h]
  ...
  \end{tabular}
  \caption{Comparison of the chlorophyll-a values collected using different methods is shown on the scatterplots on the top panel and the geographical locations of those samples is shown on the maps in the bottom panel.}
  \label{figA.1.1.1-2}
  % Figure A.1.1.1-2 
\end{figure}
...
{{\large \textsf{Description}}}\\
\hline
{{\large \textsf{NO2NO3\_0}}}&
{{\large \textsf{Nitrate+Nitrite / Unknown method}}}\\
\hline
{{\large \textsf{NO2NO3\_Alp\_F}}}&
{{\large \textsf{Nitrate+Nitrite / Alpchem / Frozen}}}\\
\hline
{{\large \textsf{NO2NO3\_Alp\_SF}}}&
{{\large \textsf{Nitrate+Nitrite / Alpchem / SuperFrozen}}}\\
\hline
{{\large \textsf{NO2NO3\_S\&P1968}}}&
{{\large \textsf{Nitrate+Nitrite/ S\&P(1968) / filtered and frozen}}}\\
\hline
{{\large \textsf{NO2NO3\_Tech\_F}}}&
{{\large \textsf{Nitrate+Nitrite / Technicon / Frozen}}}\\
\hline
{{\large \textsf{NO2NO3\_Tech\_Fsh}}}&
{{\large \textsf{Nitrate + Nitrite / Technicon / Fresh / Strain / Unfiltered}}}\\
\hline
{{\large \textsf{NO2NO3\_Tech\_SF}}}&
{{\large \textsf{Nitrate+Nitrite / Technicon / SuperFrozen}}}\\
\hline
{{\large \textsf{NO2NO3\_Tech2\_F}}}&
{{\large \textsf{Nitrate+Nitrite / Technicon2 / Frozen}}}\\
\hline
{{\large \textsf{NO3\_Tech\_F}}}&
{{\large \textsf{Nitrate / Technicon / Frozen, corrected for NO2}}}\\
\hline
{{\large \textsf{NO3\_Tech\_SF}}}&
{{\large \textsf{Nitrate / Technicon / SuperFrozen}}}\\
\hline
\end{tabular}
\end{table}
...
\begin{figure}[h]
  ...
  \label{phosphateTimeseries}
\end{figure}

Silicate
Silicate data available in BioChem are mapped to 8 methods. The methods are listed and described in Table \ref{tableSilicateMethods}x and the time series of data associated with each method is shown on Figure x.
