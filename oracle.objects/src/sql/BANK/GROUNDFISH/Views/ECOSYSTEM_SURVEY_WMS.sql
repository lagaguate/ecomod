--------------------------------------------------------
--  DDL for View ECOSYSTEM_SURVEY_WMS
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "GROUNDFISH"."ECOSYSTEM_SURVEY_WMS" ("INSTITUTIONCODE", "COLLECTIONCODE", "CATALOGNUMBER", "FIELDNUMBER", "COLLECTOR", "YEARCOLLECTED", "MONTHCOLLECTED", "DAYCOLLECTED", "TIMEOFDAY", "STARTYEARCOLLECTED", "STARTMONTHCOLLECTED", "STARTDAYCOLLECTED", "STARTTIMEOFDAY", "ENDYEARCOLLECTED", "ENDMONTHCOLLECTED", "ENDDAYCOLLECTED", "ENDTIMEOFDAY", "CONTINENTOCEAN", "LOCALITY", "STARTLATITUDE", "STARTLONGITUDE", "ENDLATITUDE", "ENDLONGITUDE", "LATITUDE", "LONGITUDE", "LON05", "LON10", "LON20", "LON30", "LAT05", "LAT10", "LAT20", "LAT30", "MINIMUMDEPTH", "MAXIMUMDEPTH", "TEMPERATURE", "SAMPLESIZE", "SCIENTIFICNAME", "KINGDOM_", "PHYLUM_", "CLASS_", "ORDER_", "FAMILY_", "GENUS_", "SPECIES_", "ACCEPTED_AUTHOR", "SUBSPECIES_", "SUBGENUS", "BASISOFRECORD", "COUNTRY", "GIVEN_SPEC_CODE", "COMMONNAME", "FAO_CODE", "TSN", "GEAR", "GEARDESCRIPTION", "TARGETSPECIES", "SPECIES", "MISSION", "SETNO", "DECADE", "LENCLASS", "LENCLASS_10CM", "STDCLEN") AS 
...
/* Cod, Haddock, Pollock, Redfish unseparated, yellowtail flounder, herring (atlantic) */
   ...
   ORDER BY collectioncode, yearcollected, setno, species, lenclass ;
 

   COMMENT ON TABLE "GROUNDFISH"."ECOSYSTEM_SURVEY_WMS"  IS 'OBIS Schema style std counts at length from the SUMMER survey for COD, HADDOCK, REDFISH UNSEPARATED,POLLOCK, HERRING and YELLOWTAIL FLOUNDER';
