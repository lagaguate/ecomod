--------------------------------------------------------
--  DDL for View ITIS_GS_MULTIPLE_TSN_VW
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "GROUNDFISH"."ITIS_GS_MULTIPLE_TSN_VW" ("GIVEN_COMMON_NAME", "GIVEN_SPEC_CODE", "GIVEN_SCIENT_NAME", "GIVEN_TSN", "ACCEPTED_TSN", "UNACCEPT_REASON", "SPECIES_", "GENUS_", "FAMILY_", "ORDER_", "CLASS_", "PHYLUM_", "KINGDOM_", "USAGE", "CREDIBILITY_RTNG") AS 
  (
select
...
from itis_gs_taxon_tsn_vw a 
INNER JOIN
itis_gs_taxon_accepted_vw b
