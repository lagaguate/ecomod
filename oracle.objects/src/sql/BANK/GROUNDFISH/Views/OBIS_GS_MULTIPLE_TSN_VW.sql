--------------------------------------------------------
--  DDL for View OBIS_GS_MULTIPLE_TSN_VW
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "GROUNDFISH"."OBIS_GS_MULTIPLE_TSN_VW" ("GIVEN_COMMON_NAME", "GIVEN_SPEC_CODE", "GIVEN_SCIENT_NAME", "GIVEN_TSN", "ACCEPTED_TSN", "UNACCEPT_REASON", "SPECIES_", "GENUS_", "FAMILY_", "ORDER_", "CLASS_", "PHYLUM_", "KINGDOM_", "USAGE", "CREDIBILITY_RTNG") AS 
  (
select
...
from obis_gs_species_tsn_vw a 
INNER JOIN
obis_gs_species_accepted_vw b
