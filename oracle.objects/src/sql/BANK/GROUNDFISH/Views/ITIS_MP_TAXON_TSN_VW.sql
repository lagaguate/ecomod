--------------------------------------------------------
--  DDL for View ITIS_MP_TAXON_TSN_VW
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "GROUNDFISH"."ITIS_MP_TAXON_TSN_VW" ("GIVEN_SCIENT_NAME", "GIVEN_SPEC_CODE", "GIVEN_TSN", "ACCEPTED_TSN", "UNACCEPT_REASON") AS 
  (
...
CASE
  ...
  ELSE null
END givenname3 
from MP_SPECIES_CODES_USED_VW) o
INNER JOIN
