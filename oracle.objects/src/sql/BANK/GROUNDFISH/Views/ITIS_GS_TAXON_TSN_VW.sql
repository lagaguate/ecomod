--------------------------------------------------------
--  DDL for View ITIS_GS_TAXON_TSN_VW
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "GROUNDFISH"."ITIS_GS_TAXON_TSN_VW" ("GIVEN_SCIENT_NAME", "GIVEN_SPEC_CODE", "GIVEN_TSN", "ACCEPTED_TSN", "UNACCEPT_REASON") AS 
  (
