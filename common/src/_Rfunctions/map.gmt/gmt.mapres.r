  gmt.mapres = function(params) {
    ...
    params$res = "-I1m"
    if (params$mapres %in% c("10sec"))					 params$res = "-I10c" # 10 second grid
    if (params$mapres %in% c("15sec"))					 params$res = "-I15c" # 15 second grid
    if (params$mapres %in% c("20sec", "high"))   params$res = "-I20c" # 20 second grid
    if (params$mapres %in% c("30sec"))		       params$res = "-I30c" # 30 second grid
