correlationCircle <- function(corr, col=c("black","white"), bg = "white", 
	cex = 1, order = FALSE, title = "", ...){

#// examples
#data(mtcars)
#circle.corr( cor(mtcars), order = TRUE, bg = "gray50", col = colorRampPalette(c("blue","white","red"))(100) )
#corr Correlation matrix to represent
#col vector the fill color of circles from 1 to -1
#the length of it may not be 2, eg rainbow(50)
#bg background color of graph
#cex numeric, for the variable names
#order whether reorder the variables using principal 
